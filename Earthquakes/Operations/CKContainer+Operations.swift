...
extension CKContainer {
    /**
        ...
        be `nil`.
    */
    func verifyPermission(permission: CKContainer_Application_Permissions, requestingIfNecessary shouldRequest: Bool = false, completion: @escaping (NSError?) -> Void) {
...
/**
    ...
    `CKContainer`.
*/
private func verifyAccountStatus(container: CKContainer, permission: CKContainer_Application_Permissions, shouldRequest: Bool, completion: @escaping (NSError?) -> Void) {
...
private func verifyPermission(container: CKContainer, permission: CKContainer_Application_Permissions, shouldRequest: Bool, completion: @escaping (NSError?) -> Void) {
...
private func requestPermission(container: CKContainer, permission: CKContainer_Application_Permissions, completion: @escaping (NSError?) -> Void) {
