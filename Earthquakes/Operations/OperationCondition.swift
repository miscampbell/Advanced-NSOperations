...
struct OperationConditionEvaluator {
    static func evaluate(conditions: [OperationCondition], operation: EQOperation, completion: @escaping ([NSError]) -> Void) {
        // Check conditions.
        ...
        conditionGroup.notify(queue: DispatchQueue.global(qos: .background)) {
