...
//            Dictionary(sequence: myCategories) { $0.identifier }
        
        let newCategories = settings.categories ?? []
        let newCategoriesByIdentifier = [String: UIUserNotificationCategory]()
//            Dictionary(sequence: newCategories) { $0.identifier }
